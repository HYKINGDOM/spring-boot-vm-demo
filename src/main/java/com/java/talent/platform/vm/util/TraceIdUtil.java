...
public class TraceIdUtil {
    ...
    /**
     * TraceID设置规则 1, TTL和MDC都不存在TraceID,生成TraceID并设置到TTL和MDC当中 2, 如果MDC中有但是TTL中没有,将MDC中的TraceID设置到TTL 3,
     * 如果TTL中有但是MDC中没有,将TTL中的TraceID设置到TTL 4, 如果TTL中的TraceID和MDC中的TraceId不相等,则以TTL中为准
     *
     * @return traceId
     */
